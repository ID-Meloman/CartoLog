# Generated by Django 5.1.2 on 2024-11-03 20:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compare', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_set', to='main.car', verbose_name='Автомобили для сравнения')),
                ('favorite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compare_set', to='main.car', verbose_name='Избранные автомобили')),
            ],
            options={
